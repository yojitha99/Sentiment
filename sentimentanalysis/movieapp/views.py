...
def showreview(request,id):
    ...
    moviename=Movie.objects.get(id=id).mname
    print("in showreview try",reviews)
    return render(request,"showreview.html",{'reviews':reviews,'movieid':id,'moviename':moviename})
    #except:
...
def showgraph(request,id):
    ...
    return render(request,"showgraph.html",{'poscount':poscount,'negcount':negcount,'moviename':moviename})
